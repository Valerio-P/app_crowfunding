<template>
  <div id="howitworks" style="margin-top: 100px">
    <!-- Page header-->
      ...
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-7 col-md-6 offset-md-1 col-12 order-md-2 order-1">
          <div class="tns-carousel-wrapper tns-controls-static tns-nav-outside">
            <div class="tns-carousel-inner-works1">
              <div>
                <img
                  class="rounded-3"
                  src="@/assets/images/about-us/01.jpg"
                  alt="Carousel image"
                />
              </div>
              <div>
                <img
                  class="rounded-3"
                  src="@/assets/images/about-us/02.jpg"
                  alt="Carousel image"
                />
              </div>
            </div>
    ...
    <section class="container mb-2 mb-xl-5 pb-lg-4">
      ...
      <div class="tns-carousel-wrapper tns-nav-outside">
        <div class="tns-carousel-inner-works2">
          <!-- Feature slide-->
          <div>
      ...
      <div class="row gy-4">
        <div class="col-md-5 col-12">
          <img
            ...
            src="@/assets/images/about-us/find.svg"
            alt="Illustration"
          />
        </div>
          ...
          <div class="steps steps-vertical">
            <div class="step active">
              ...
              <div class="step-label ms-4">
                ...
                <p class="mb-0">
                  ...
                  metus. Imperdiet sed massa amet at turpis. Dis risus, donec in
                  ac ultricies tempor eu, amet.
                </p>
              </div>
            </div>
            <div class="step active">
            ...
            <div class="step active">
              ...
              <div class="step-label ms-4">
                ...
                <p class="mb-0">
                  Ut mattis nascetur aliquam neque velit nunc sed. Morbi congue
                  mauris amet ultrices molestie tellus proin odio diam. Feugiat
                  elit, habitasse egestas egestas id nec potenti. Donec
                  convallis donec tristique mattis et viverra.
                </p>
              </div>
            </div>
          </div>
    ...
    <section class="container mb-5 pb-2 pb-lg-4">
      ...
      >
        ...
        <div
          class="
            tns-carousel-controls tns-controls-static
            d-sm-flex d-none
            ms-4
          "
      ...
      >
        <div class="tns-carousel-inner-works3 row gx-4 mx-0 pt-3 pb-4">
          <!-- Team slide-->
          <div class="col">
            <div class="card border-0 shadow-sm mt-md-4">
              <img
                class="card-img-top"
                src="@/assets/images/agents/04.jpg"
                alt="Devon Lane"
              />
              <div class="card-body text-center">
                <h3 class="h5 card-title mb-2">Devon Lane</h3>
                <span class="d-inline-block mb-3 fs-sm">Real Estate Agent</span>
                <div class="pt-1">
                  <a
                    class="
          ...
          <div class="col">
            <div class="card border-0 shadow-sm">
              <img
                class="card-img-top"
                src="@/assets/images/agents/05.jpg"
                alt="Dianne Russell"
              />
              <div class="card-body text-center">
                <h3 class="h5 card-title mb-2">Dianne Russell</h3>
                <span class="d-inline-block mb-3 fs-sm">Finance Director</span>
                <div class="pt-1">
                  <a
                    class="
                      btn btn-icon btn-light-primary btn-xs
          ...
          <div class="col">
            <div class="card border-0 shadow-sm mt-md-4">
              <img
                class="card-img-top"
                src="@/assets/images/agents/06.jpg"
                alt="Ronald Richards"
              />
              <div class="card-body text-center">
                <h3 class="h5 card-title mb-2">Ronald Richards</h3>
                <span class="d-inline-block mb-3 fs-sm">Sales Executive</span>
                <div class="pt-1">
                  <a
                    class="
                      btn btn-icon btn-light-primary btn-xs
          ...
          <div class="col">
            <div class="card border-0 shadow-sm">
              <img
                class="card-img-top"
                src="@/assets/images/agents/07.jpg"
                alt="Albert Flores"
              />
              <div class="card-body text-center">
                <h3 class="h5 card-title mb-2">Albert Flores</h3>
                <span class="d-inline-block mb-3 fs-sm">Property Manager</span>
                <div class="pt-1">
                  <a
                    class="
                      btn btn-icon btn-light-primary btn-xs
    ...
    <section class="container mb-5 pb-xl-5 pb-md-2">
      ...
      <div
        class="
          ...
          tns-controls-outside-lg
          tns-nav-outside
          tns-nav-outside-flush
          col-lg-10
          mx-auto
          px-0
        "
      >
        <div class="tns-carousel-inner-works4">
          <!-- Testimonial slide-->
          <div
            class="
              d-flex
          ...
          >
            <img
              class="d-md-block d-none me-4 rounded-3"
              src="@/assets/images/about-us/customer1.jpg"
              width="306"
              alt="Customer image"
            />
            <div class="card border-0 shadow-sm h-100">
              <blockquote class="blockquote card-body">
                <p>
                  Eu massa, pharetra massa integer. Sed molestie sollicitudin
                  morbi ultrices. Odio is euismodtelle faucibus. Venenatis nunc,
                  tristique turpis cras sodales. In dui, viverra et ac. Id
                  justo, varius nunc, faucibus erat proin elit. Amet diam,
                  aliquet nec quis vel. Donec ut quisque in lorem sapien.
                </p>
                <footer class="d-flex align-items-center">
                  <img
                    src="@/assets/images/about-us/zalo-lg.png"
                    width="56"
                    alt="Logo"
                  />
                  <div class="ps-3">
          ...
          <div class="d-flex align-items-start mx-3 py-3">
            <img
              class="d-md-block d-none me-4 rounded-3"
              src="@/assets/images/about-us/customer2.jpg"
              width="306"
              alt="Customer image"
            />
            <div class="card border-0 shadow-sm h-100">
              <blockquote class="blockquote card-body">
                ...
                <footer class="d-flex align-items-center">
                  <img
                    src="@/assets/images/about-us/elastic-lg.png"
                    width="56"
                    alt="Logo"
                  />
                  <div class="ps-3">
      ...
      <div class="bg-secondary rounded-3">
        ...
        >
          ...
          <div class="col-4 d-md-block d-none align-self-end px-0">
            <img
              class="mt-n5"
              src="@/assets/images/about-us/03.png"
              width="406"
              alt="Cover image"
            />
          </div>
        ...
        <div class="tns-carousel-inner-works5 d-block">
          ...
          <article>
            ...
            <h3 class="fs-base pt-1">
              <a class="nav-link" href="real-estate-blog-single.html"
                >7 Tips for Achieving Maximum Coziness</a
              >
            </h3>
          ...
          <article>
            <a class="d-block mb-3" href="real-estate-blog-single.html"
              ><img
                class="rounded-3"
                src="@/assets/images/about-us/highlights/03.jpg"
                alt="Post image" /></a
            ><a class="fs-xs text-uppercase text-decoration-none" href=""
              >Inspiration</a
            >
            <h3 class="fs-base pt-1">
              <a class="nav-link" href="real-estate-blog-single.html"
                >5 Easy-to-Ambitious Projects to Improve Your Home</a
              >
            </h3>
...
export default {
  ...
  mounted() {
    this.slider1 = tns({
      container: ".tns-carousel-inner-works1",
      loop: true,
      gutter: 16,
      autoplay: true,
    ...
    this.slider2 = tns({
      container: ".tns-carousel-inner-works2",
      loop: false,
      controls: false,
      responsive: {
        0: { items: 1, gutter: 16 },
        500: { items: 2, gutter: 20 },
        768: { items: 3, gutter: 24 },
      },
      navPosition: "bottom",
    });

    this.slider3 = tns({
      container: ".tns-carousel-inner-works3",
      controlsContainer: "#external-controls",
      responsive: {
        0: { items: 1 },
        500: { items: 2 },
        768: { items: 3 },
    ...
    this.slider5 = tns({
      container: ".tns-carousel-inner-works5",
      controls: false,
      gutter: 24,
      autoHeight: true,
      responsive: {
