<template>
  ...
  <section class="container mb-5 pb-2 pb-lg-4">
    <h2 class="h3 mb-4 pb-3 text-center text-md-start">
      Top real estate agents
    </h2>
    <div class="tns-carousel-wrapper">
      <div
        class="tns-carousel-inner-agents"
      >
        <div>
          <div class="row align-items-center">
            <div class="col-xl-4 d-none d-xl-block">
              <img
                class="rounded-3"
                src="@/assets/images/agents/01.jpg"
                alt="Agent picture"
              />
            </div>
            <div class="col-xl-4 col-md-5 col-sm-4">
              <img
                class="rounded-3"
                src="@/assets/images/agents/02.jpg"
                alt="Agent picture"
              />
            </div>
            <div
              class="
                col-xl-4 col-md-7 col-sm-8
                px-4 px-sm-3 px-md-0
                ms-md-n4
                mt-n5 mt-sm-0
                py-3
              "
                  ...
                  <footer class="d-flex justify-content-between">
                    ...
                    <div>
                      <span class="star-rating"
                        ><i class="star-rating-icon fas fa-star active"></i
                        ><i class="star-rating-icon fas fa-star active"></i
                        ><i class="star-rating-icon fas fa-star active"></i
                        ><i class="star-rating-icon fas fa-star active"></i
                        ><i class="star-rating-icon fas fa-star active"></i
        ...
        <div>
          <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-md-5 col-sm-4">
              <img
                class="rounded-3"
                src="@/assets/images/agents/03.jpg"
                alt="Agent picture"
              />
            </div>
            <div
            ...
            >
              <div class="card border-0 shadow-sm ms-sm-n5">
                <blockquote class="blockquote card-body">
                  <h4 style="max-width: 22rem">
                    &quot;I don't say no, I just figure out a way to make it
                    work&quot;
                  </h4>
                  <p class="d-sm-none d-lg-block">
...
export default {
  ...
  mounted() {
    this.slider = tns({
      ...
      items: 1,
      mode: "gallery",
      controlsContainer: "#agents-carousel-controls",
      nav: false,
    });
  },
