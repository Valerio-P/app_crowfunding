<template>
  <section id="recently" class="container pb-4 pt-1 mb-5">
    <div
      class="
        d-flex
    ...
    >
      ...
      >
        ...
        <div class="dropdown d-md-none" data-bs-toggle="select">
          ...
          >
            <span class="dropdown-toggle-label">Houses</span>
          </button>
          <input type="hidden" />
          <div class="dropdown-menu">
            ...
            ><a class="dropdown-item" href="#"
              ><span class="dropdown-item-label">Rooms</span></a
            ><a class="dropdown-item" href="#"
      ...
      <a
        ...
        href=""
        >View all<i class="fas fa-arrow-right ms-2"></i></a>
    </div>
    <div class="row g-4">
      <div class="col-md-6">
        <div
